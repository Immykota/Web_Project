...
{	
	...
	var previousexperience=document.register.previousexperience;
	...
	if(userName(name))
	{
	  if(empId(empid))
	  {
      if(previousExperience(previousexperience))
	  {
...
function previousExperience(previousexperience)
{
	
	var letters=/^[0-9]+$/;
	if(previousexperience.value.match(letters)&&previousexperience.value<50)
	{
		return true;
	}
	else
...
<body>
		<% String s1=(String)request.getParameter("value");
		   System.out.println(" value of id"+s1);
		    %>
...
<tr>
	<td>EMPID:</td>
	<td><input type=text  name="empid" id="ntid"/></td>
</tr>

<tr>
	<td>Previous Experience:</td>
	<td><input type=text  name="previousexperience" id="previousexperience"/></td>
</tr>
<tr>
	<td>Joining Date:</td>
	<td><input onclick="ds_sh(this);" name="date"  style="cursor: text" /><br /></td> 
</tr>
...
<center>
<pre>
     <input type=button value="Back" onClick="window.location.href='Home.jsp'"> <input type=button value="ADD" onClick="return formValidation()"/>  
</pre>
</center>
